...
BLOCK_SIZE_M, BLOCK_SIZE_N, BLOCK_SIZE_K, GROUP_SIZE_M, num_warps = arguments['BLOCK_SIZE_M'], arguments['BLOCK_SIZE_N'], arguments['BLOCK_SIZE_K'], arguments['GROUP_SIZE_M'], arguments['num_warps']
...
print(f"BLOCK_SIZE_M={BLOCK_SIZE_M} BLOCK_SIZE_N={BLOCK_SIZE_N} BLOCK_SIZE_K={BLOCK_SIZE_K} GROUP_SIZE_M={GROUP_SIZE_M} num_warps={num_warps} num_stages={num_stages}")
