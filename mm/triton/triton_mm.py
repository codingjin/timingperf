...
required_args = ['M', 'N', 'K', 'BLOCK_SIZE_M', 'BLOCK_SIZE_N', 'BLOCK_SIZE_K', 'GROUP_SIZE_M', 'num_warps']
...
M, N, K = int(arguments['M']), int(arguments['N']), int(arguments['K'])
...
print(f"M={M} N={N} K={K} bm_size={bm_size} bn_size={bn_size} bk_size={bk_size} gp_size={gp_size} num_stages=2 num_warps={arguments['num_warps']}")
print(f"Performance is {2*0.000001*M*N*K/median_time:.0f} GFLOPs")
